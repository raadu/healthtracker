...
public class userinfo extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view == imageView) {
            ...
            if (editTextName.getText().length() == 0 || editTextAge.getText().length() == 0 || editTextSex.getText().length() == 0 || editTextFeet.getText().length() == 0 ||
                    editTextInch.getText().length() == 0 || editTextWeight.getText().length() == 0) {
